...
import { FaGithub, FaReact, FaNodeJs, FaDatabase, FaJs, FaLock, FaBolt, FaCloud, FaCodeBranch } from 'react-icons/fa';
import { SiTailwindcss, SiMongodb, SiFirebase, SiAxios } from 'react-icons/si';
import { Tooltip } from 'react-tooltip';

const frontendSkills = [
    { icon: <FaReact size={32} />, title: 'React', desc: 'Building dynamic and performant user interfaces.' },
    { icon: <SiTailwindcss size={32} />, title: 'Tailwind CSS', desc: 'Utility-first CSS framework for responsive design.' },
    { icon: <FaJs size={32} />, title: 'JavaScript', desc: 'The programming language of the web.' },
];

const backendSkills = [
    { icon: <FaNodeJs size={32} />, title: 'Node.js', desc: 'JavaScript runtime for building server-side applications.' },
    { icon: <SiMongodb size={32} />, title: 'MongoDB', desc: 'NoSQL database for modern web applications.' },
    { icon: <SiFirebase size={32} />, title: 'Firebase', desc: 'Backend-as-a-Service platform by Google.' },
];

const otherSkills = [
    { icon: <FaGithub size={32} />, title: 'GitHub', desc: 'Hosting and version control for code repositories.' },
    { icon: <FaCodeBranch size={32} />, title: 'Git', desc: 'Version control system for tracking changes in source code.' },
    { icon: <FaBolt size={32} />, title: 'AI Tools', desc: 'Using artificial intelligence tools in development workflows.' },
];
                        ...
                        >
                            <div className="card bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all p-6 border border-gray-300 dark:border-gray-700 rounded-xl h-full flex flex-col justify-between">
                                <div className="flex flex-col items-center h-full">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 text-center flex-grow">{skill.desc}</p>
                                </div>
                            </div>
                        </motion.div>
                    ))}
