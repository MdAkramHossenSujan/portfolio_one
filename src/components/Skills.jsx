      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-10">
        <AnimatePresence>
          {skills.map((skill, index) => (
            ...
            >
              <div className="card text-gray-900 dark:text-white shadow-sm shadow-gray-400 dark:shadow-gray-500 hover:shadow-md hover:scale-[1.02] transition-all p-6 border border-gray-400 dark:border-gray-600 rounded-xl h-full flex flex-col justify-between">
                <div className="flex flex-col items-center h-full">
                  ...
                  <p className="text-gray-600 text-sm italic dark:text-gray-400 text-center flex-grow">
                    {`"${skill.expertise}"`}
                  </p>
                </div>
              </div>
